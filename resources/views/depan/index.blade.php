    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded  mb-5" width="300" height="300" src="{{asset('foto'). "/" . get_meta_value('_foto')}}" alt="..." /></span>
            </a>
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        ...
                        <div class="resume-section-contect"><a href="{{get_meta_value('_email')}}">{{get_meta_value('_email')}}</a></div>
                        
                    </div>
                    <div class="lead mb-5">{!!$about->isi!!}</div>
                    <div class="social-icons">
                        <a class="social-icon" href="{{get_meta_value('_lingkedin')}}"><i class="fab fa-linkedin-in"></i></a>
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <ul class="list-inline dev-icons">
                        @foreach (explode(', ', get_meta_value('_languange')) as $item)
