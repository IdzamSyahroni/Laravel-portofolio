    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="{{route('halaman.index')}}"><img src="{{ asset('admin') }}/images/logo.svg" alt="logo"/></a>
          {{-- <a class="navbar-brand brand-logo-mini" href="{{route('halaman.index')}}"><img src="{{ asset('admin') }}/images/logo-mini.svg" alt="logo"/></a> --}}
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
          <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Instagram <a href="https://www.instagram.com/m.idzamsyahroni/" target="_blank">Muhamad Idzam Syahroni</a></span>
          <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Twitter <a href="https://twitter.com/IdzamMuhamad" target="_blank"> Muhamad Idzam Syahroni  </a></span>
        </div>
        </footer>
        <!-- partial -->
      </div>
